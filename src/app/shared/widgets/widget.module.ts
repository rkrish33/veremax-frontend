...
@NgModule({
    ...
    declarations: [StatchartComponent, OverviewComponent, MembersComponent, TaskComponent, ChatComponent, StatprogressComponent, StatComponent, ChartComponent, Profile1Component, Profile2Component, Profile3Component, Profile4Component, ActivitiesComponent, CustomToastComponent],
    imports: [
        CommonModule,
        NgApexchartsModule,
        UIModule,
    ...
    // tslint:disable-next-line: max-line-length
    exports: [StatchartComponent, OverviewComponent, MembersComponent, TaskComponent, ChatComponent, StatprogressComponent, StatComponent, ChartComponent, Profile1Component, Profile2Component, Profile3Component, Profile4Component, ActivitiesComponent, CustomToastComponent]
})
