...
@Component({
  selector: 'app-list-emp-department',
  templateUrl: './list-emp-department.component.html',
  styleUrls: ['./list-emp-department.component.scss']
})
export class ListEmpDepartmentComponent implements OnInit {
...
async listEmpDepartment(){
  let res=await this.employee.ListEmpDepartment({
